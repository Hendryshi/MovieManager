...
begin tran
update J_Actor set favLevel = 3 where name = '÷Òƒ⁄œƒœ£'
update J_Actor set favLevel = 3 where name = '≥ı¥®§ﬂ§ §ﬂ'
update J_Actor set favLevel = 3 where name = 'ª®õg§“§ﬁ§Í'
update J_Actor set favLevel = 3 where name = 'ø˚Àæ'
update J_Actor set favLevel = 3 where name = '√¿π»÷Ï¿Ô'
update J_Actor set favLevel = 3 where name = '√˜¿Ô§ƒ§‡§Æ'
update J_Actor set favLevel = 3 where name = 'œ„ÀÆ§∏§Â§Û'
update J_Actor set favLevel = 3 where name = 'õˆ…≠§Ï§‡'
update J_Actor set favLevel = 3 where name = '…ÒåmÀ¬• •™'
update J_Actor set favLevel = 3 where name = 'À{—ø§ﬂ§∫§≠'
update J_Actor set favLevel = 3 where name = '∞ÀíÏ§¶§ﬂ'
update J_Actor set favLevel = 3 where name = '“¡ÃŸŒË—©'
update J_Actor set favLevel = 3 where name = '–«åm“ªª®'
update J_Actor set favLevel = 3 where name = '”…ê€ø…ƒŒ'
update J_Actor set favLevel = 3 where name = 'Ã“ƒÀƒæ§´§ '
update J_Actor set favLevel = 3 where name = '·µ§ § §ﬂ'
update J_Actor set favLevel = 3 where name = 'º”√¿–”ƒŒ'
update J_Actor set favLevel = 3 where name = '∞◊∑Â•ﬂ•¶'
update J_Actor set favLevel = 3 where name = 'œ‡õg§ﬂ§ §ﬂ'
update J_Actor set favLevel = 3 where name = 'î»ÃŸ§¢§ﬂ§Í'
update J_Actor set favLevel = 3 where name = 'ó@ø’§‚§‚'
update J_Actor set favLevel = 1 where name = '–°“∞«Ÿπ≠'
commit